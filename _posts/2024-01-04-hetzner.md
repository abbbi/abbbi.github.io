...
DHCP, as the original does. If REAR detects changed static network
configuration it guides you through the setup pretty nicely.
...
Being able to use this procedure, to recover your Hetzner cloud VPS from
off-site backups gives me a better feeling, too.
