...
block sizes, the I/O becomes buffered, async, and as it stands, dd as user
space application does not validate the write operation (or uses fsync) to
notice errors during buffered I/O operations by default.
